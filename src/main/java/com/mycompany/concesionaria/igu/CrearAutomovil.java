...
public class CrearAutomovil extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Creacion de Automovil");
        ...
        cbPuertas.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "3", "5" }));
        cbPuertas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbPuertasActionPerformed(evt);
            }
        });
    ...
    private void cbPuertasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbPuertasActionPerformed
        
    }//GEN-LAST:event_cbPuertasActionPerformed
    ...
    String puerta = (String) cbPuertas.getSelectedItem();
    control.guardarAutomovil(modelo,marca,motor,color,patente,puerta);
